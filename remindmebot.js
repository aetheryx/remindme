...
client.on("message", msg => {
    ...
    if (cmd === "stats" || cmd === "info") {
        ...
        let os = require("os"),
            ...
            .addField("RAM Usage", `${(process.memoryUsage().heapUsed / 1048576).toFixed()}MB/${(os.totalmem() > 1073741824 ? (os.totalmem() / 1024000000).toFixed(1) + " GB" : (os.totalmem() / 1024000).toFixed() + " MB")} (${(process.memoryUsage().heapUsed / os.totalmem() * 100).toFixed(2)}%)`, true)
