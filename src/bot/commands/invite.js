async function inviteCommand (Bot, msg, args) {
  ...
  Bot.sendMessage(msg.channel.id, { embed: {
    ...
    description: `Click [here](https://discordapp.com/oauth2/authorize?permissions=27648&scope=bot&client_id=${id}) to invite me to your server, or click [here](https://discord.gg/Yphr6WG) for an invite to RemindMeBot's support server.`
  }});
}
